...
class _HomeScreenState extends State<HomeScreen>
  ...
  void initState() {
    ...
    //To change data based on selected tab use
    //_tabController.index to retrieve the index of the selected tab
    // and use that index in build method to retrieve the data
    //based on that index
  }
